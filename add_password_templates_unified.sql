-- إدراج قوالب كلمة المرور في قاعدة البيانات (موحد)
-- يشمل: قالب كلمة المرور المؤقتة + قالب إشعار إعادة تعيين كلمة المرور
...
-- عرض النتائج
SELECT 
    'تم إدراج قوالب كلمة المرور بنجاح' as status;

SELECT 
    'أنواع الإشعارات المضافة:' as info;
SELECT 
    name,
    name_ar,
    name_en,
...
WHERE name IN ('temporary_password', 'password_reset_success');

SELECT 
    'القوالب المضافة:' as info;
SELECT 
    name,
    name_ar,
    name_en,
