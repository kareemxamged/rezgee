-- إدراج قالب كلمة المرور المؤقتة في قاعدة البيانات
...
-- إدراج قالب كلمة المرور المؤقتة - النسخة العربية
...
<body>
    ...
    html_template_ar = EXCLUDED.html_template_ar,
    html_template_en = EXCLUDED.html_template_en,
    is_active = EXCLUDED.is_active,
    updated_at = NOW();
