...
function getSMTPForTemplate($templateId) {
    ...
    $smtpSettings = [
        '723ddbd8-bceb-4bdb-aafa-6160cedbe2da' => [
            ...
            'smtp_port' => 465,
            'smtp_username' => 'noreply@rezgee.com',
            'smtp_password' => 'password123',
            'from_email' => 'noreply@rezgee.com',
            'from_name_ar' => 'رزقي - منصة الزواج الإسلامي',
            'from_name_en' => 'Rezge - Islamic Marriage Platform',
            'reply_to' => 'support@rezgee.com',
            'is_default' => false,
            'is_active' => true
        ],
        '834eecf9-cdfc-5cec-bbfb-7271dfcef3eb' => [
            ...
            'smtp_host' => 'smtp.hostinger.com',
            'smtp_port' => 465,
            'smtp_username' => 'welcome@rezgee.com',
            'smtp_password' => 'password456',
            'from_email' => 'welcome@rezgee.com',
            'from_name_ar' => 'فريق الترحيب - رزقي',
            'from_name_en' => 'Welcome Team - Rezge',
            'reply_to' => 'welcome@rezgee.com',
            'is_default' => false,
            'is_active' => true
        ],
        '945ffdg0-defd-6dfd-ccgc-8382egdfg4fc' => [
            ...
            'smtp_host' => 'smtp.hostinger.com',
            'smtp_port' => 465,
            'smtp_username' => 'contact@rezgee.com',
            'smtp_password' => 'password789',
            'from_email' => 'contact@rezgee.com',
            'from_name_ar' => 'فريق التواصل - رزقي',
            'from_name_en' => 'Contact Team - Rezge',
            'reply_to' => 'contact@rezgee.com',
            'is_default' => false,
            'is_active' => true
        ]
    ];
