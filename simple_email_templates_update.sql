-- تحديث بسيط لقوالب الإيميلات - رزقي
-- Simple Email Templates Update - Rezge
...
-- 4. إدراج القوالب الأساسية المستخدمة فعلياً
...
-- 5. إدراج أنواع الإشعارات البريدية المستخدمة فعلياً
