      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16 lg:h-20">
          ...
          <div className="flex items-center gap-2 lg:gap-4">
            {/* Language toggle - hidden on mobile, shown on tablet and desktop */}
          ...
          <>
            <div className="lg:hidden absolute top-full left-0 right-0 bg-white border-t border-slate-200 shadow-xl z-40 animate-slideDown">
              <div className="px-4 py-6 space-y-4">
                {/* Language Toggle for Mobile only (hidden on tablet and desktop) */}
                <div className="lg:hidden flex justify-center pb-4 border-b border-slate-200 animate-fadeIn">
                  <LanguageToggle />
                </div>
                ...
                {isAuthenticated && (
                  <div className="pt-4 border-t border-slate-200 space-y-3 animate-fadeIn">
                    ...
                    <button
                      ...
                      className="mobile-menu-item animate-slideInRight w-full flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-red-50 transition-all duration-200 text-red-600"
                    >
                      <LogOut className="w-5 h-5" />
                      <span>{t('navigation.logout')}</span>
                    </button>
