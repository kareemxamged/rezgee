          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-xl border border-white/20 overflow-hidden">
            ...
            <div className="p-6 pt-0">
              <div className="flex items-center justify-center gap-4">
                <button
                  onClick={handlePass}
                  className="w-16 h-16 bg-slate-100 hover:bg-slate-200 rounded-full flex items-center justify-center transition-colors group"
                >
                  <X className="w-8 h-8 text-slate-600 group-hover:text-slate-800" />
                </button>
                
                <button
                  onClick={handleLike}
                  className="w-20 h-20 bg-gradient-to-r from-pink-500 to-red-500 hover:from-pink-600 hover:to-red-600 rounded-full flex items-center justify-center transition-all transform hover:scale-105 shadow-lg"
                >
                  <Heart className="w-10 h-10 text-white" />
                </button>
                
                <button
                  className="w-16 h-16 bg-primary-100 hover:bg-primary-200 rounded-full flex items-center justify-center transition-colors group"
                >
                  <MessageCircle className="w-8 h-8 text-primary-600 group-hover:text-primary-800" />
                </button>
              </div>
