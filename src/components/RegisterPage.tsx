              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all duration-200"
                    placeholder={t('auth.register.nationalityPlaceholder')}
                  />
                  {errors.nationality && (
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="high">{t('auth.register.religiousCommitmentHigh')}</option>
                    <option value="medium">{t('auth.register.religiousCommitmentMedium')}</option>
                    <option value="practicing">{t('auth.register.religiousCommitmentPracticing')}</option>
                  </select>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="slightly_religious">{t('auth.register.religiosityLevelSomewhatReligious')}</option>
                    <option value="religious">{t('auth.register.religiosityLevelReligious')}</option>
                    <option value="very_religious">{t('auth.register.religiosityLevelVeryReligious')}</option>
                  </select>
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="never">{t('auth.register.smokingNever')}</option>
                    <option value="occasionally">{t('auth.register.smokingOccasionally')}</option>
                    <option value="regularly">{t('auth.register.smokingRegularly')}</option>
                  </select>
                  {errors.smoking && (
