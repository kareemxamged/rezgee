...
function runAllTests() {
  ...
  const tests = [
    { name: 'قالب تعطيل المصادقة الثنائية', test: testTwoFactorDisableTemplate },
    { name: 'قالب الترحيب بالمستخدمين الجدد', test: testWelcomeNewUserTemplate },
    { name: 'المحتوى العربي', test: testArabicContent },
    { name: 'المحتوى الإنجليزي', test: testEnglishContent },
    { name: 'التصميم HTML', test: testHTMLDesign },
    { name: 'هيكل قاعدة البيانات', test: testDatabaseStructure },
    { name: 'التكامل مع النظام', test: testSystemIntegration }
  ];
