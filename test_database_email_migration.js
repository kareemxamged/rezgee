...
function runAllTests() {
    ...
    const tests = [{
            name: 'UnifiedDatabaseEmailService',
            test: testUnifiedDatabaseEmailService
        },
        {
            name: 'NotificationEmailServiceDatabase',
            test: testNotificationEmailServiceDatabase
        },
        {
            name: 'AuthEmailServiceDatabase',
        ...
        {
            name: 'معالجة المتغيرات',
            test: testVariableProcessing
        },
        {
            name: 'معالجة الشروط الشرطية',
            test: testConditionalProcessing
        },
        {
            name: 'دعم اللغات',
            test: testLanguageSupport
        },
        {
            name: 'التكامل مع قاعدة البيانات',
